...
<div>
    <div class="row justify-content-center bg-dark">
        ...
        <div class="row">
                ...
                <div class="col-2 bg-dark  text-light fs-2   my-3 ">
                    <p>Rating:  {{ $Movie-> rating }}</p>
                    <div class="col-6 bg-dark  text-light fs-2   my-3 ">
                    <p>Rating:  {{ $Movie-> rating }}</p>
                    <p>Rating:  {{ $Movie-> rating }}</p>
                    <p>Rating:  {{ $Movie-> rating }}</p>
                </div>
        ...
        <div class="container  bg-dark text-light fs-3">
            <div class="row">
                ...
                <div class="row">
            <div class="col-2 bg-dark  text-light fs-2   my-4 ">
