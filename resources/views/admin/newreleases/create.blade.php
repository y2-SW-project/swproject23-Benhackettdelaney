...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="my-6 p-6 bg-dark border-b border-gray-200 shadow-sm sm:rounded-lg">
            <form action="{{ route('admin.newreleases.store') }}" method="post" enctype="multipart/form-data">

                @csrf
                <input type="text" name="age_group" field="age_group" placeholder="age_group" class="w-full" autocomplete="off" :value="@old('age group..')"></input>
